...
### XBEE SETUP
local_device = XBeeDevice("COM6", 9600) # Blue XBee
local_device.open()
remote_device = RemoteXBeeDevice(local_device, XBee64BitAddress.from_hex_string("0013A20041C1A0D8")) # Orange XBee
...
while not done:
    ...
    u_leader.append(.02 * np.sin(k * elapsed_time * Omega)) # u_leader(k)
